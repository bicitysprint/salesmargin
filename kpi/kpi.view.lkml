...
###################################    drill sets    #####################################
  ...
  set: jobcount_detail_ {
    fields: [allocatedregion,allocatedsc,accountcode,accountname,consolno,clientno,clientname,jobno,dimops.bookingtype,dimops.operator,servicecode,sla_job_type,driverkey,bookingdatetime_date,bookingdatetime_time_of_day,job_creation_date,job_creation_time_of_day,allocated_date,allocated_time,collection_arrival_time_of_day,time_to_collect,collection_window,collectionsla_,delivery_arrival_date,delivery_arrival_time_of_day,delivery_datetime_date,delivery_datetime_time_of_day,
